class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
         ...
         validates :password, presence: {message: "is invalid. Include both letters and numbers"}
         validates :nick_name, presence: true
         validates :last_name, presence: true
         validates :last_name, presence: {message: "is invalid. Input full-width characters"}
         validates :first_name, presence: true
         validates :first_name, presence: {message: "is invalid. Input full-width characters"}
